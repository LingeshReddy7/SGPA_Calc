...
import com.example.new_app.ui.gallery.GalleryViewModel;
...
//                textView5.setText(s);
                if(TextUtils.isEmpty(editTextNumber.getText().toString()) ||  TextUtils.isEmpty(editTextNumber3.getText().toString()) || TextUtils.isEmpty(editTextNumber4.getText().toString()) || TextUtils.isEmpty(editTextNumber5.getText().toString())
                    ...
                    float sgpa = ((Float.valueOf(Integer.parseInt(i)/10)+1)*3  + (Float.valueOf(Integer.parseInt(i3)/10)+1)*3 + (Float.valueOf(Integer.parseInt(i4)/10)+1)*3 +(Float.valueOf(Integer.parseInt(i5)/10)+1)*3 + (Float.valueOf(Integer.parseInt(i6)/10)+1)*3 + (Float.valueOf(Integer.parseInt(i7)/10)+1)*2 + (Float.valueOf(Integer.parseInt(i8)/10)+1)*2 +  (Float.valueOf(Integer.parseInt(i9)/10)+1)*1)/20;
